...
def pca_first_component(red, green, nir):
    ...
    # Option 1: manually do PCA
    # 1) mask out nans if needed:
...
output_base = r"D:\SeasoNet\Indices Implementation\snow_results\cbi"
...
def process_sample(i_row):
    ...
    if i % 50 == 0:
        ...
        overlay = create_overlay(cbi, labels, biased_threshold, urban_classes_present, nonurban_classes_present)
        plt.imshow(overlay)
